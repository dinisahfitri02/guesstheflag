...
class DummyData {
  static final List<Question> questionList = [
    const Question(
      id: 0,
      image: 'assets/flags/argentina.jpg',
      options: ['Argentina', 'Uruguay', 'Brazil', 'Chile', 'Paraguay'],
      answer: 'Argentina',
    ),
    const Question(
      id: 1,
    ...
    const Question(
      id: 6,
      image: 'assets/flags/mongolia.png',
      options: ['Mongolia', 'China', 'Kazakhstan', 'Russia', 'Kyrgyzstan'],
      answer: 'Mongolia',
    ),
    const Question(
      id: 7,
    ...
    const Question(
      id: 12,
      image: 'assets/flags/qatar.png',
      options: ['Qatar', 'Bahrain', 'Oman', 'Saudi Arabia', 'Kuwait'],
      answer: 'Qatar',
    ),
    const Question(
      id: 13,
